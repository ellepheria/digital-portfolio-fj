...
На странице есть кнопка "Редактировать портфолио", при нажатию на которую пользователь переходит на страницу редактирования портфолио. 

Если пользователь еще не добавил ни одного проекта, вместо кнопки "Редактировать портфолио", должна быть кнопка "Добвить первый проект в портфолио".
...
На странице редактирования портфолио пользователь может добавить или удалить проект в портфолио.
