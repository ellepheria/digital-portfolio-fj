...
При нажатии на карточку открывается профиль пользователя. Просмотр каталога и страниц пользователей доступен как зарегистрированным, так и незарегистрированным пользователям.

По каталогу будет доступен поиск по ключевым словам. Поиск осуществляется по имени, роду деятельности и описанию.

Можно сортировать пользователей в каталоге по времени (недавно обновляли портфолио, давно не обновляли). 
