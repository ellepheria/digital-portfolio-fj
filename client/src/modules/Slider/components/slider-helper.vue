...
export default {
  ...
  data() {
    return {
      ...
      itemActive: 0, // Первый слайд
      numItemReal: 0, // Общее количество реальных слайдов
      numItemAll: 0, // Общее количество слайдов с клонами
      breakpoints: [], // Список медиа запросов
      numDot: 0, // Количество
      numDotActive: 0, // Активный дот
      transform: 0, // Сдвиг по оси Y
      ...
      mouseDown: false, // Флаг нажатия мыши
      swipeDistance: 50, // Дистанция для свайпа
      dragDistance: 0 // Дистанция перемещения курсора
    }
  },
